...
# Force reload of env vars since we just changed the file
load_dotenv(override=True)

# Re-import config after reload might not work if module is already cached.
# So let's read directly or ensure we grab the new values.
